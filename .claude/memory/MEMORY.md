...
- [Docker-first dev tools](feedback_docker_first.md) — run dev tools/tests in Docker, not on the host; canonical wrangler-in-container recipe lives in CLAUDE.md.
